...
def main():
    ...
    st.markdown('<h3 align="center">SuperResolve Low Res Image to High Res Image</h3>',unsafe_allow_html=True)
    ...
    if uploaded_file is not None:
        if is_image(uploaded_file):
            ...
            if is_not_big(lr_img):
                ...
                st.markdown("### <span style='color:red'>Caution:</span> Hardware Limitation. Can't Process Image larger than 256x256.",unsafe_allow_html=True)
    else:
